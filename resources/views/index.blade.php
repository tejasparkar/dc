...
<body>
            ...
            <div class="swiper-wrapper cta__slider">
                ...
                <div class="cta__slider-item swiper-slide">
                    <div class="media-wrapper slide-inner valign">
                        <div class="bg-img" data-background="img/slid/1.jpg" data-overlay-dark="0"></div>
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-10 offset-lg-1">
                                    <div class="caption">
                                        ...
                                        <div class="custom-font">
                                            <h5 class="thin custom-font white" >interior</h5>
                ...
                <div class="cta__slider-item swiper-slide">
                    <div class="media-wrapper slide-inner valign">
                        <div class="bg-img" data-background="img/slid/2.jpg" data-overlay-dark="0"></div>
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-10 offset-lg-1">
                                    <div class="caption">
                                        ...
                                        <span class="bottom-corn"></span>
                                        <div class="custom-font">
                                            <h5 class="thin custom-font white">Innovative</h5>
                ...
                <div class="cta__slider-item swiper-slide">
                    <div class="media-wrapper slide-inner valign">
                        <div class="bg-img" data-background="img/slid/3.jpg" data-overlay-dark="0"></div>
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-10 offset-lg-1">
                                    <div class="caption">
                                        ...
                                        <span class="bottom-corn"></span>
                                        <div class="custom-font">
                                            <h5 class="thin custom-font white">Elegant &</h5>
                                            <h1 data-splitting><a href="#0">
                                                    Unique Design
                                                </a>
                                            </h1>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="item-sm wow fadeInUp" data-wow-delay="1s">
                            <div class="box">
                                <h6 class="mb-20"><span class="custom-font numb">{{$data}}</span> Architecture</h6>
    ...
    <section class="portfolio full-bg">
        ...
        <div class="glry-img">
            <div id="tab-1" class="bg-img tab-img current" data-background="img/portfolio/full/01.jpg"
                data-overlay-dark="2"></div>
            <div id="tab-2" class="bg-img tab-img" data-background="img/portfolio/full/02.jpg" data-overlay-dark="2">
            </div>
            <div id="tab-3" class="bg-img tab-img" data-background="img/portfolio/full/03.jpg" data-overlay-dark="2">
            </div>
            <div id="tab-4" class="bg-img tab-img" data-background="img/portfolio/full/04.jpg" data-overlay-dark="2">
            </div>
        </div>
    </section>
